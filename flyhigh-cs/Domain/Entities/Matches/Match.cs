...
public class Match : AuditableEntity<MatchId>
{
  ...
  {
    if (setRules == null) 
      throw new MatchInvalidException(nameof(setRules));

    if (matchRules == null) 
      throw new MatchInvalidException(nameof(matchRules));
  ...
  public void AcceptInvitation()
  {
    ...
    // Note: Tady by se standardně přes MediatR vystřelil DomainEvent, který následně vytvoří 'Event' entitu.
  }
  ...
  public void StartMatch()
  {
    ...
    _sets.Add(MatchSet.Create(1, SetType.Normal, _setRules));
    MarkAsModified();
  }
  ...
  private void HandleFinishedSet()
  {
    ...
    bool isTieBreak = homeWins == 2 && awayWins == 2;
